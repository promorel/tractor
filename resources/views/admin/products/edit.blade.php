            ...
            <div class="card-body">
                <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <label for="main_image_url" class="form-label">Nouvelle URL d'image (optionnel)</label>
                        <input type="url" 
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('characteristics') is-invalid @enderror" 
                                  ...
                                  rows="5">{{ old('characteristics', $product->characteristics) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" 
                                   ...
                                   id="average_price" 
                                   name="average_price" 
                                   value="{{ old('average_price', $product->average_price) }}" 
                                   step="0.01"
                                   min="0"
                                   required>
                            @error('average_price')
        ...
        try {
            ...
            preview.innerHTML = `
                <div class="alert alert-info">
                    <strong>Aperçu de la nouvelle image :</strong><br>
                    <img src="${url}" 
